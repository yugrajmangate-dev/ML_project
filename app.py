...
print("Loading Recommendation Model... Please wait...")
start = time.time()
recommender = Recommender('recommendation_model.pkl')
...
def dashboard():
    ...
    if current_user.customer_id:
        res = recommender.recommend_collaborative(current_user.customer_id, 8)
        if "products" in res:
...
def view_product(stock_code):
    ...
    res = recommender.recommend_content(product.Description or stock_code, 4)
